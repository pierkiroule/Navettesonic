...
const STAR_NETWORK_LINK_DISTANCE = 96;
const STAR_NETWORK_BRANCH_REST_LENGTH = 138;
const MUSIC_CORE_TOUCH_RADIUS = 104;
const MUSIC_CORE_LINK_REST_LENGTH = 156;
const STAR_NETWORK_MIN_SEPARATION = 112;
const MUSIC_CORE_MIN_SEPARATION = 138;
const STAR_NETWORK_SPACING_FORCE = 0.012;
const STAR_NETWORK_LINK_STIFFNESS = 0.018;
const MUSIC_CORE_LINK_STIFFNESS_MULTIPLIER = 0.38;
const STAR_NETWORK_BREAK_THRESHOLD = 54;
const STAR_NETWORK_RUPTURE_STRETCH = 1.22;
const STAR_NETWORK_RUPTURE_EXTRA_DISTANCE = 34;
const STAR_NETWORK_PUSH_MEMORY_MS = 1800;
const STAR_NETWORK_DAMPING = 0.982;
